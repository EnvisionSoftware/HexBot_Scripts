...
public class AIOPickpocketGui extends Gui {

	public AIOPickpocketGui(Script script) {
		super("AIOThiever v1.0", script);
	...
	class MainPanel extends JPanel {
		...
		private final EventHandler eventHandler = new EventHandler(this, getFrame());
