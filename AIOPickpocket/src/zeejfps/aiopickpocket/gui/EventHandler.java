...
import zeejfps.aiopickpocket.gui.AIOPickpocketGui.MainPanel;

class EventHandler implements ActionListener, MouseInputListener, KeyListener, FocusListener{

	private MainPanel panel;
	private JFrame window;
	
	public EventHandler(MainPanel panel, JFrame window) {
		this.panel = panel;
		this.window = window;
	}
	...
	private void removeFromList() {
		...
		if (panel.getList().equals(window.getFocusOwner())) {
